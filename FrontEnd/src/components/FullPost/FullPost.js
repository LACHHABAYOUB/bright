...
*/
    ...
    let post = <p style={{ justifyContent: 'space-around' }}> Please select a Reporting!</p>;
    if (props.match.params.id != null) {
        post = (
            <div className="FullPost">
                <div><br/></div><h1> Title :test</h1><div><br/></div>

                <div><br/></div><p> Content :test</p><div><br/></div>

                <div className="flex">

                    <div className="edit">
                        <button onClick={() => setVisibility(!show)}> Edit Reporting</button>
...
*/}
                    ...
                    <div className="delete">
                        <button onClick={deletePost} >Delete Reporting</button>
                    </div>
